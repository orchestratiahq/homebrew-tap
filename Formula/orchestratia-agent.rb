class OrchestratiaAgent < Formula
  ...
  url "https://github.com/kumarimlab/orchestratia-agent/archive/refs/tags/v0.18.0.tar.gz"
  sha256 "133362ef511aa7e7a84285218734816deda221614d5e46fa1ee9913d06b625b6"
  license "MIT"
